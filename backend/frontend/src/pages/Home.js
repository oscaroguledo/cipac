        ...
        <div>
            ...
            <div className="container marketing">
                    ...
                    <div className="col-md-5 img">
                        <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src={pic3}  aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                    </div>
                </div>
                <hr className="featurette-divider" />
                <div className="row persons p-1 pt-4">
                <div className="col-lg-4">
                    <img className="bd-placeholder-img rounded-circle" width="140" height="140" src={pic9}  aria-label="Placeholder: 500x500" />
                ...
                <div className="col-lg-4">
                    <img className="bd-placeholder-img rounded-circle" width="140" height="140" src={{pic12}}  aria-label="Placeholder: 500x500" />
                ...
                <div className="col-lg-4">
                    <img className="bd-placeholder-img rounded-circle" width="140" height="140" src={pic11}  aria-label="Placeholder: 500x500" />
                ...
                <div className="col-md-5 img">
                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src={pic10}  aria-label="Placeholder: 500x500" focusable="false" />
                </div>
                </div>
                ...
                <div className="col-md-5">
                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src={pic8} aria-label="Placeholder: 500x500" focusable="false" />
                </div>
                </div>
